...
addon_info = AddonInfo(
	...
	addon_name="WindowsList",
	# Add-on summary, usually the user visible name of the addon.
	# Translators: Summary for this add-on
	# to be shown on installation and add-on information found in Add-ons Manager.
	addon_summary=_("Windows List"),
	# Add-on description
	# Translators: Long description to be shown for this add-on on add-on information from add-ons manager
	addon_description=_("""This add-on uses to show a windows list dialog."""),
	# version
	addon_version="1.0",
	# Author(s)
	addon_author="Hoang-Long2012",
	# Brief changelog for this version
	# Translators: what's new content for the add-on version to be shown in the add-on store
	addon_changelog="changelog.html",
	# URL for the add-on documentation support
	addon_url="https://github.com/Hoang-Long2012/WindowsList",
	# URL for the add-on repository where the source code can be found
	addon_sourceURL="https://github.com/Hoang-Long2012/WindowsList",
...
pythonSources: list[str] = ["addon/globalPlugins/WindowsList/*.py"]
